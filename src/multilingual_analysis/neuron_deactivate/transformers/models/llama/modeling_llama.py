...
class LlamaMLP(nn.Module):
    ...
    def forward(self, x, deactivate_keys_fwd_up, deactivate_keys_fwd_down):
...
class LlamaAttention(nn.Module):
    ...
    def forward(
        ...
        position_embeddings: tuple[torch.Tensor, torch.Tensor] | None = None,  # will become mandatory in v4.45
        ...
        **kwargs,
        ...
        for k_index in deactivate_keys_k:
            self.k_proj.weight[k_index, :] = 0
        for v_index in deactivate_keys_v:
            self.v_proj.weight[v_index, :] = 0
